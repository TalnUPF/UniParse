...
dataset_folder=/homedtic/lperez/datasets/1-billion-word-language-modeling-benchmark-r13output/conll_normal
train_file=$dataset_folder/1b_train.conllu
dev_file=$dataset_folder/1b_dev.mini.conllu
test_file=$dataset_folder/1b_test.conllu

results_folder=/homedtic/lperez/UniParse/saved_models/1b/normal3
