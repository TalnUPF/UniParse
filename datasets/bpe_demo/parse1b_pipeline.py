...
if __name__ == "__main__":
    ...
    if False:
        ...
        output_file = '/home/lpmayos/code/UniParse/datasets/PTB_SD_3_3_0/dev.gold.pieced.conll'
        ...
        output_file = '/home/lpmayos/code/UniParse/datasets/PTB_SD_3_3_0/train.gold.pieced.conll'
        reconstruct_dependency_trees(conll_file, model_prefix, output_file)

        conll_file = '/home/lpmayos/code/UniParse/datasets/PTB_SD_3_3_0/test.gold.conll'
        output_file = '/home/lpmayos/code/UniParse/datasets/PTB_SD_3_3_0/test.gold.pieced.conll'
        reconstruct_dependency_trees(conll_file, model_prefix, output_file)
