...
python kiperwasser_main.py --results_folder /homedtic/lperez/UniParse/saved_models/kiperwasser_en_ptb_BPE --logging_file logging.log --do_training True --train_file /homedtic/lperez/UniParse/datasets/PTB_SD_3_3_0/train.gold.bpe.conll --dev_file /homedtic/lperez/UniParse/datasets/PTB_SD_3_3_0/dev.gold.bpe.conll --test_file /homedtic/lperez/UniParse/datasets/PTB_SD_3_3_0/test.gold.bpe.conll --output_file output_ptb_bpe.output --model_file model_bpe.model --vocab_file vocab_bpe.pkl --dynet-devices GPU:0,GPU:1
